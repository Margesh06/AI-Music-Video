...
# PEXELS_API_KEY = "iU9BH7N2W0hAsmsPmPUPR50reEZZRouNQh9bLUA2DYqH4HDkA8kdGffX"

# # Soundstripe API Details
# SOUNDSTRIPE_API_URL = "https://api.soundstripe.com/v1/songs"
# SOUNDSTRIPE_API_KEY = "xXaswJ94BOhVrY8OvwPcpYRtdNVDLm0SoZsZ7yDe2VaBJdKNZEJwESwDYGEC7oW2"


# def download_video_from_pexels(query, download_path):
#     headers = {"Authorization": PEXELS_API_KEY}
#     params = {"query": query, "per_page": 3}  # Fetch up to 3 videos for variety
...
#     }
#     params = {"search": query, "limit": 3}  # Fetch up to 3 tracks for variety
